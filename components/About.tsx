        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
              ...
              With a blend of technical expertise in the MERN stack and a creative eye for graphic
              design, I build modern web applications and compelling visual identities that resonate
              with users.
            </p>
            ...
            <div className="text-base sm:text-lg text-gray-300 leading-relaxed">
              ...
              <ul className="space-y-2 ml-4">
                <li>
                  <span className="text-yellow-400">•</span> <strong>Web Development:</strong>{" "}
                  MongoDB, Express.js, React.js, Node.js
                </li>
                <li>
                  <span className="text-yellow-400">•</span> <strong>Frontend Technologies:</strong>{" "}
                  Next.js, Tailwind CSS, JavaScript
                </li>
                <li>
                  <span className="text-yellow-400">•</span> <strong>Graphic Design:</strong>{" "}
                  Photoshop, Illustrator, Figma, Canva
                </li>
                <li>
                  <span className="text-yellow-400">•</span> <strong>UI/UX & Branding:</strong> Logo
                  Design, Typography, User Interface Design
                </li>
                <li>
                  <span className="text-yellow-400">•</span> <strong>Multimedia:</strong> Video
