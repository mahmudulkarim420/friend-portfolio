...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus({
        type: 'success',
        message: 'Thank you for your message! Your email has been sent successfully.',
      });
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">khusbladesignmax@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-300">01768373397</p>
                </div>
              </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/kushbula-ahmed-nahiyan/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gradient-to-r hover:from-[#ff6b6b] hover:to-[#ffd93d] text-white rounded-full flex items-center justify-center transition-all duration-200">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gradient-to-r hover:from-[#ff6b6b] hover:to-[#ffd93d] text-white rounded-full flex items-center justify-center transition-all duration-200">
                ...
                <a href="https://www.facebook.com/share/1CkpXnPgLs/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-gradient-to-r hover:from-[#ff6b6b] hover:to-[#ffd93d] text-white rounded-full flex items-center justify-center transition-all duration-200">
